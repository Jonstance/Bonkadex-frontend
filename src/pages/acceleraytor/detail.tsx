...
function LotteryLicense({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      the Bonkadex website, including AcceleRaytor, (the "Prohibited Jurisdictions") are not permitted to make use of
      these services or participate in this token sale. For the avoidance of doubt, the foregoing restrictions on any of
      the services offered on the Bonkadex website from Prohibited Jurisdictions apply equally to residents and citizens
